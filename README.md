Без проблем, держи максимально лаконичный вариант. Такой README отлично подойдет для того, чтобы быстро развернуть проект и сразу перейти к тестированию API.
